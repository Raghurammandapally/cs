...
abstract class ASTnode { 
    ...
    static public int currOffset;
    static public String currReturnLabel;
...
class FnDeclNode extends DeclNode {
    ...
    public void codeGen() {
      ...
      currReturnLabel = Codegen.nextLabel();
      ...
      if(myId.name().equals("main")) {
        ...
        Codegen.generateFnDecl(myId.getAddr());
      }
      //# (1) push return addr
      //  sw   $ra, 0($sp)
      //  subu $sp, $sp, 4
      ...
      Codegen.genLabel(currReturnLabel, "exit for " + myId.name());
...
class PostIncStmtNode extends StmtNode {
    ...
    public void codeGen() {
      //not dealing with structs
      IdNode id = (IdNode) myExp;
      // loads address and pushes it onto stack
      id.codeGen();
      id.genAddr();
      //pop id addr into $t0
      Codegen.genPop(Codegen.T0);
      //pop id value into $t1
...
class CallStmtNode extends StmtNode {
    ...
    public void codeGen() {
      //leaves return value on the stack, even for void fn
      myCall.codeGen();
...
class ReturnStmtNode extends StmtNode {
    ...
    public void codeGen() {
      ...
      Codegen.generate("j", currReturnLabel);
    }
...
class StringLitNode extends ExpNode {
    ...
    public void codeGen() {
      if(!strings.containsKey(myStrVal)) {
        strings.put(myStrVal, Codegen.generateStringStore(myStrVal));
      }

      Codegen.generateStringLoad(strings.get(myStrVal));
    }
...
class IdNode extends ExpNode {
    ...
    public void genAddr() {
      String reg = Codegen.T0;
      Codegen.generate("la", reg, getAddr());
      Codegen.genPush(reg);
    }
    ...
    public void codeGen() {
      Codegen.generate("lw", Codegen.T0, getAddr());
      Codegen.genPush(Codegen.T0);
    }

    public String getAddr() {
      if(sym().isLocal()) {
        return sym().getOffset() + "($fp)";
      } else {
        return "_" + myStrVal;
      }
    }
...
class AssignNode extends ExpNode {
    ...
    public void codeGen() {
      ...
      //  we can cast myLhs because we are not dealing with structs
