...
\begin{center}
\begin{forest}
  [expr:\\ \fbox{$a < b$}, align=center, base=bottom]

  [INTLIT\\ ``val'', align=center, base=bottom]
  [ID\\ ``val'', align=center, base=bottom]
  [list\\ \fbox{${}$}, align=center, base=bottom]
  [exp\\ \fbox{${}$}, align=center, base=bottom]
  [exp\\ \fbox{${}$}, align=center, base=bottom]
